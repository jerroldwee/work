...
class Admin::ProductsControllerTest < ActionController::TestCase
  ...
  test "should create admin_product" do
    assert_difference('Admin::Product.count') do
      post :create, admin_product: { code: @admin_product.code, description: @admin_product.description, price: @admin_product.price, product_type: @admin_product.product_type, title: @admin_product.title }
    end
  ...
  test "should update admin_product" do
    patch :update, id: @admin_product, admin_product: { code: @admin_product.code, description: @admin_product.description, price: @admin_product.price, product_type: @admin_product.product_type, title: @admin_product.title }
    assert_redirected_to admin_product_path(assigns(:admin_product))
  end
